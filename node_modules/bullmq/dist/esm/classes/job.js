...
import { errorObject, isEmpty, getParentKey, lengthInUtf8Bytes, tryCatch, } from '../utils';
...
export class Job {
     ...
     */
    asJSONSandbox() {
        return Object.assign(Object.assign({}, this.asJSON()), { queueName: this.queueName, parent: this.parent ? Object.assign({}, this.parent) : undefined, prefix: this.prefix });
    }
    /**
    ...
    async moveToCompleted(returnValue, token, fetchNext = true) {
        ...
        return this.scripts.moveToCompleted(this, stringifiedReturnValue, this.opts.removeOnComplete, token, fetchNext);
    }
    /**
    ...
    async moveToFailed(err, token, fetchNext = false) {
        ...
        if (this.attemptsMade < this.opts.attempts &&
            ...
            if (delay === -1) {
                ...
                // Retry immediately
                multi.retryJob(this.scripts.retryJobArgs(this));
                command = 'retry';
            }
        }
        else {
    ...
    async getChildrenValues() {
        ...
        if (result) {
            return fromPairs(Object.entries(result).map(([k, v]) => [k, JSON.parse(v)]));
        }
    }
    /**
    ...
    async getDependencies(opts = {}) {
        ...
        if (!opts.processed && !opts.unprocessed) {
            ...
            const transformedProcessed = Object.entries(processed).reduce((accumulator, [key, value]) => {
                return Object.assign(Object.assign({}, accumulator), { [key]: JSON.parse(value) });
            }, {});
            ...
            const [unprocessedCursor, unprocessed = []] = opts.unprocessed
                ? opts.processed
                    ...
                    : result1[1]
                : [];
            const transformedProcessed = processed.reduce((accumulator, currentValue, index) => {
                if (index % 2) {
                    return Object.assign(Object.assign({}, accumulator), { [processed[index - 1]]: JSON.parse(currentValue) });
                }
                return accumulator;
            }, {});
